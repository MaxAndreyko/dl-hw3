...
from src.dataset import TextDataset # FIX: просто dataset заменил на src.dataset (в соответствии со своей структурой)
...
class LanguageModel(nn.Module):
    def __init__(self, dataset: TextDataset, embed_size: int = 256, hidden_size: int = 256,
        ...
        self.embedding = nn.Embedding(
            num_embeddings=dataset.vocab_size,  # Corrected line
    ...
    def inference(self, prefix: str = '', temp: float = 0.1) -> str:
        ...
        tokens = self.dataset.text2ids(prefix) # [bos, prefix] # FIX: убрал [:-1]
